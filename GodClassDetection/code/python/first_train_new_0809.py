...
import preprocess0809  # 引入自定义的preprocess.py,所以preprocess.py不是主函数
import interaction1
...
x_train, y_train = preprocess0809.get_xy_train(TRAIN_SET_DIR + '/data', tokenizer=tokenizer, mn_maxlen=MAX_SEQUENCE_LENGTH,
...
m_j_merged_a = concatenate([lstm_a, mtrdense_a, interaction_a, interaction_b, interaction_c1, interaction_c2, interaction_c3], axis=-1)
...
model_final = Model(inputs=[method_a, metric_a, att_a, att_b, att_c1, att_c2, att_c3], output=total_output)
...
with open(r'/Users/knight/Desktop/GodClassDetection/trained_model/pre_training_model_int_20.json', 'w') as file:
    file.write(model_json)

# 保存预训练的模型
model_final.save('/Users/knight/Desktop/GodClassDetection/trained_model/pre_training_model_int_20.h5')
