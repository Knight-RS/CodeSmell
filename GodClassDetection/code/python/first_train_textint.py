...
m_j_merged_a = concatenate(
    # [lstm_a, mtrdense_a, interaction_a, interaction_b, interaction_c1, interaction_c2, interaction_c3], axis=-1)
    [lstm_a, mtrdense_a, interaction_b], axis=-1)
...
model_final = Model(inputs=[method_a, metric_a, att_b], output=total_output)
...
with open(r'E:/GodClassDetection/trained_model/pre_training_model_text_int_10.json', 'w') as file:
    file.write(model_json)

# 保存预训练的模型
model_final.save('E:/GodClassDetection/trained_model/pre_training_model_text_int_10.h5')
