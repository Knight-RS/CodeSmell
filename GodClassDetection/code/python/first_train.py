...
hist = model_final.fit(x_train, y_train, nb_epoch=100, batch_size=5, verbose=1)
...
with open(r'/Users/knight/Desktop/GodClassDetection/trained_model/pre_training_model_int.json', 'w') as file:
    file.write(model_json)

# 保存预训练的模型
model_final.save('/Users/knight/Desktop/GodClassDetection/trained_model/pre_training_model_int.h5')
