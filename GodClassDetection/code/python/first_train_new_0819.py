...
with open(r'E:/GodClassDetection/trained_model/pre_training_model_int_10.json', 'w') as file:
    file.write(model_json)

# 保存预训练的模型
model_final.save('E:/GodClassDetection/trained_model/pre_training_model_int_10.h5')
