...
# 加载预训练的模型
model_path = 'E:/GodClassDetection/trained_model/pre_training_model_10.h5'
...
for project in sorted(os.listdir(test_path)):
    print(project)
    x_val, y_val = preprocess.get_xy_test(test_path, project, tokenizer=tokenizer, maxlen=MAX_SEQUENCE_LENGTH,
